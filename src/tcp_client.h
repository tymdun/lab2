...
// *action and message must be allocated by the function and freed by the
// caller.* When this function is called, action must point to the action string
// and the message must point to the message string.
